...
const GrantCard = (props: Props) => {
  ...
  return (
    <div>
      <div className="flex items-center justify-between py-0 w-[900px] h-[360px] border-[0.5px] border-borderColor bg-white my-4 px-4 cursor-pointer">
        <div className="w-[320px] h-[350px] flex items-center justify-center rounded-[15px] mr-4">
          <img src="/GrantsImage.svg" className="w-[350px] object-cover " />
        </div>
        <div>
          <h4 className="text-primary mx-2 text-[20px] leading-[26px] font-semibold">
