...
const CustomModalComponent = (props: Props) => {
  return (
            ...
            <div className="mt-8">
              ...
              <div className="ml-5 mt-8">
                ...
                <ul className="list-disc">
                  <li className="my-1">
                    <p className="font-mono text-sm font-normal text-secondaryTextColor">
                      Provided guidance on key sustainability metrics improving
                      the program's funding eligibility.
                    </p>{" "}
                  </li>
                  <li>
                    <p className="font-mono text-sm font-normal text-secondaryTextColor">
          ...
          <div className=" bg-white pl-4 rounded-[10px] w-[500px] py-2">
            ...
            <div className="pt-4 pr-4">
              ...
              <div className="flex w-full items-center justify-between ">
                <div>
                  {[1, 2, 3, 4, 5].map((data) => (
                    <StarOutlined style={{ color: "#FBBC05", fontSize: 12 }} />
                  ))}
                </div>
