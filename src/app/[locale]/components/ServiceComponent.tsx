...
const ServiceComponent = ({ data }: { data: Props }) => {
  ...
  return (
    <div
      ...
      className={` flex items-center justify-center border cursor-pointer h-[100px] w-[90px] sm:w-[170px] lg:h-[200px] lg:w-[200px] 2lg:h-[211px] 2lg:w-[201px] ${
        ...
        data.margin ? "-mt-32 " : "mt-0 m-2 lg:m-4 "
      }`}>
