...
function Footer({}: Props) {
  return (
    <div className="bg-[url('/footerImage.svg')] px-8 mt-16 py-4">
      {/* Top */}
      ...
      <div className="flex items-start justify-between w-full mt-8">
        ...
        <div>
          ...
          <p className="w-[300px] text-white text-sm font-semibold ">
            ...
            fames. orem ipsum dolor sit amet consectetur. Varius dignissim quam
            id fames. orem ipsum dolor sit amet consectetur. Varius dignissim
            quam id fames. orem ipsum dolor sit amet consectetur. Varius
            dignissim quam id fames
          </p>
      ...
      <p className="text-white font-thin mt-8">Copyright @Grantsconsult 2024</p>
    </div>
  );
}
